...
//    public static void main(String[] args) throws IOException {
    public DownloadResults() throws IOException {
        String filePB = "powerball.txt"; //The file that will be saved on your computer
        ...
        String fileMM = "megamillions.txt"; //The file that will be saved on your computer
        ...
        String fileSL = "superlotto.txt"; //The file that will be saved on your computer
        ...
        String fileF5 = "fantasy5.txt"; //The file that will be saved on your computer
        ...
        String fileD4 = "daily4.txt"; //The file that will be saved on your computer
        ...
        String fileD3 = "daily3.txt"; //The file that will be saved on your computer
        ...
        String fileDD = "dailyderby.txt"; //The file that will be saved on your computer
        URL linkDD = new URL("http://www.calottery.com/sitecore/content/Miscellaneous/download-numbers/?GameName=daily-derby"); //The file that you want to download
...
//Daily Derby
        InputStream inDD = new BufferedInputStream(linkDD.openStream());
        ByteArrayOutputStream outDD = new ByteArrayOutputStream();
...
//Daily 3
	...
	outD3.close();
        ...
        fosD3.close();
//Daily Derby
        while (-1!=(n=inDD.read(buf)))
	{
            outDD.write(buf, 0, n);
        }
	outDD.close();
        inDD.close();
        byte[] responseDD = outDD.toByteArray();
        
        FileOutputStream fosDD = new FileOutputStream(fileDD);
        fosDD.write(responseDD);
        fosDD.close();
    }
}
